        ...
        return {
            ...
            methods: {
                ...
                init: function () {
                    ...
                    //TODO - странице реактирования при изминении почты
                ...
                updateSxMailInOrder: function () {
                    ...
                    select.addColumn("SxMail.Id", "SxMail");
                    ...
                    bq.execute(function (result) {
                        ...
                        debugger
                        update.setParameterValue("SxMail", mail[0].SxMail, Terrasoft.DataValueType.GUID);
                ...
                */
                ...
                createRequestToNP: function (weight) {
                    ...
                    bq.execute(function (result) {
                        ...
                        var isAddress = collection[0].SxIsAddress;
                        var isRedelivery = collection[0].SxIsRedelivery;
