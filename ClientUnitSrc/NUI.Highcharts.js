...
// default adapters below.
	...
	defaultOptions = {
		...
		chart: {
			...
			spacingLeft: 10,
			style: {
				fontFamily: '"Segoe UI", "Lucida Grande", "Lucida Sans Unicode", Verdana, Arial, Helvetica, sans-serif', // default font
				fontSize: '14px'
			},
...
// general renderer
	...
	Chart.prototype = {
		...
		getChartSize: function () {
			...
			// BrowserSupport: IE, FF получаем размер элемента в который отрисовывается график.
