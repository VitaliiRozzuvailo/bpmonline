define('SchemaDesignerModule',
	...
	function(Ext, Terrasoft, sandbox, designerViewGenerator, resources, maskHelper, configurationEnums, designData) {
				...
				function(context) {
					...
					designViewModel = Ext.create('Terrasoft.SchemaDesignerViewModel', {
						values: {												// TODO: create VM columns
							NewColumns: new Terrasoft.Collection(),				// TODO: Нужно ли это, если мы всегда удаляем элементы
							schema: designSchema,
		...
		function loadSchema(schemaName, callback, scope) { // TODO: получать схему из дизайнера
			var map = {};
			map[schemaName] = {
		...
		function getDesignSchema(schemaConfig, callback, scope) {				// TODO: возможно стоит получать схемы из дизайнера
		...
		function createDesignViewModelClass() {
			...
			Ext.define('Terrasoft.Configuration.SchemaDesignerViewModel', {
				...
				moveSchemaItemUp: function(schemaItem) {
					...
					renderView(schema);																	// TODO: придумать более быстрый вариант рендеринга
				},
