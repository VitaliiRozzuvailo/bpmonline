define("SxDeliveryAndAddressPage", ["BusinessRuleModule"], function (BusinessRuleModule) {
    return {
        ...
        attributes: {
            ...
            "Country": {
                isRequired: false//{ bindTo: "isCountryRequired" }
            },
            "Address": {
                isRequired: false//{ bindTo: "isAddressRequired" }
            },
            "AddressSuggest": {
                ...
                lookupListConfig: {
                    filters: [
                        function () {
                            ...
                            filterGroup.add("IsEmployee", Terrasoft.createColumnFilterWithParameter(Terrasoft.ComparisonType.EQUAL, "Type.Name", "Сотрудник"));
                            filterGroup.add("IsCourier", Terrasoft.createColumnFilterWithParameter(Terrasoft.ComparisonType.EQUAL, "Job.Name", "Курьер"));
                            return filterGroup;
                        }
                    ]
                }
        ...
        methods: {
            refreshAddressOfDepartment: function () {
                ...
                if (this.get("SxNumOfDepartament")) {
                    ...
                    if (address.length > 1) {
                        var addressDep = this.get("City").displayValue + ", " + address[1];
                        this.set("SxAddressOfDepartament", addressDep);
                        return;
                    }
                }
            ...
            isCourier: function () {
                ...
                //courier id
                return (at.value === "9afabd8a-bb4b-46b8-94dc-6c3cad5b373c");
            },
            ...
            onSaved: function () {
                ...
                this.sandbox.publish("UpdateEntityFromAddressDetail");
