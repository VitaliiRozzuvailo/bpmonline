define("ProductSelectionView", ["ProductSelectionViewResources", "ContainerListEx"],
    function(resources) {
        ...
        function getEditableGridConfig() {
            ...
            var advPriceConfig = {
                value: {bindTo: "PriceDisplayValue"}
            };
            var advPriceOfCountryConfig = {
                value: {bindTo: "SxPriceListMemoDisplayValue"}
            };
            var productStockConfig = {
                value: {bindTo: "productStockValue"}
            };
            var defaultRowConfig = {
                ...
                items: [
                    getEditableControlConfig("Code", "Label", 1, advCodeConfig),
                    getEditableControlConfig("Name", "Label", 7),
                    getEditableControlConfig("SxPriceOfCountry", "FloatEdit", 5, advPriceOfCountryConfig),
                    //getEditableControlConfig("Price", "FloatEdit", 2, advPriceConfig),
                    getEditableControlConfig("Available", "Label", 2, advAvailableConfig),
                    //getEditableControlConfig("SxAvailable", "Label", 2, advAvailableConfig),
        ...
        function generate() {
            ...
            var cancelButton = {
                ...
                visible: true,
                caption: "Отмена",//resources.localizableStrings.CancelButtonCaption,
            ...
            var saveButton = {
                ...
                visible: true,
                caption: "Сохранить",//resources.localizableStrings.SaveButtonCaption,
